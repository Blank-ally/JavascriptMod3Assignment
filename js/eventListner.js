...
document.getElementById("reset").addEventListener("click",function(){
    ...
    const isGlutenFree = document.getElementById('isGlutenFreeInput').checked = false
    const isVeganFree = document.getElementById('isVeganInput').checked = false 
    const isLocal = document.getElementById('isLocalInput').checked = false 
})